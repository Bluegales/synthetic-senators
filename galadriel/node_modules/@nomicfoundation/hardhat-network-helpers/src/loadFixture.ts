import type { SnapshotRestorer } from "@nomicfoundation/hardhat-network-helpers/src/helpers/takeSnapshot";
...
export async function loadFixture<T>(fixture: Fixture<T>): Promise<T> {
  ...
  const { takeSnapshot } = await import("@nomicfoundation/hardhat-network-helpers/src/helpers/takeSnapshot");
